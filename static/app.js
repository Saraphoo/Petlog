let quotes = {
	...
	createUser: function () {
			document.querySelector('form').addEventListener('submit', function (e) {
				e.preventDefault();
				let userFirstName = document.querySelector('form input[name=userFirstName]').value;
				let userLastName = document.querySelector('form input[name=userLastName]').value;
				let userEmail = document.querySelector('form input[name=userEmail]').value;
				let userPassword = document.querySelector('form input[name=userPassword').value;
	...
	locateUser: function () {
		document.querySelector('form').addEventListener('submit', function (e) {
			e.preventDefault();
			let userEmail = document.querySelector('form input[name=email]').value;
			let userPassword = document.querySelector('form input[name=password]').value;
			console.log(userEmail, userPassword);
			let payload = JSON.stringify({ email: userEmail, password: userPassword });
			console.log(payload);
